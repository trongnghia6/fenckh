...
const exportHDGvmToExcel = async (req, res) => {
  ...
  try {
    ...
    const [rows] = await connection.execute(
      "SELECT NgayBatDau, NgayKetThuc, KiHoc, DanhXung, HoTen, NgaySinh, CCCD, NoiCapCCCD, Email, MaSoThue, HocVi, ChucVu, HSL, DienThoai, STK, NganHang, SoTien, TruThue, ThucNhan, NgayNghiemThu FROM hopdonggvmoi"
    );
